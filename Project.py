...
original=pd.read_csv("C:/Python Project/Provisional_COVID-19_Deaths_by_Sex_and_Age.csv")
...
df['Footnote']=df['Footnote'].fillna('none')
df.isnull().sum()

# Objective 1:->     Comparative Mortality Analysis of Respiratory Diseases
...
# Objective 2:->      Correlation Between COVID-19 and Comorbid Respiratory Deaths
...
# Objective 3:->      Outlier Detection in Pandemic Fatalities
...
# Objective 4:->      Regional Hotspot Analysis for COVID-19 Deaths
...
# Objective 5:->      Duration of High-Mortality Phases in COVID-19 Waves
...
# Objective 6:->        Time-Series Analysis of Pandemic Death Trends
